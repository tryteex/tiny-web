...
impl Log {
    ...
    fn number_to_text(number: u16) -> &'static str {
        match number {
            ...
            50 => "The 'salt' parameter in the configuration file must be set",
            51 => "The 'lang' parameter in the configuration file must be a string and consist of two characters according to ISO 639-1",
            52 => "The 'max' parameter in the configuration file must be usize and greater than 0 or \"auto\"",
            53 => "The 'bind_from' parameter in the configuration file must be IP address in format xxx.xxx.xxx.xxx or \"any\" or empty for Unix domain socket",
            54 => "The 'bind' parameter in the configuration file must be IP:PORT address in format xxx.xxx.xxx.xxx:yyyy or Unix domain socket",
            55 => "The 'rpc_from' parameter in the configuration file must be IP address in format xxx.xxx.xxx.xxx or \"any\" or empty for Unix domain socket",
            56 => "The 'rpc' parameter in the configuration file must be IP:PORT address in format xxx.xxx.xxx.xxx:yyyy or Unix domain socket",
            ...
            69 => "The 'prepare' parameter in the configuration file must be a group",
            70 => "The Key parameter in the 'prepare' group in the configuration file must consist from two items: \"query\" and \"types\". \"Types\" ia array of string: BOOL, INT8, INT2, INT4, TEXT, VARCHAR, FLOAT4, FLOAT8, JSON, TIMESTAMPTZ, UUID, BYTEA",
            ...
            615 => "Key not found",
            616 => "Connection with database is wrong",
